    ...
    return (
        <>
            <div className="custom-card" style={styles.tavernCard}>
                {!props.isTavern ? (
                    <p style={styles.catName}>{props.cat.name}</p>
                ) : (
                    <></>
                )}
                {!props.isTavern ? (
                ...
                <p>
                    {Jobs[props.cat.class].statName}: {props.cat.power}
                </p>
                {props.isTavern ? (
                    <Button
                        className={"custom-button"}
                        onClick={namingModalOpen}
                        disabled={props.recruitLockout}
                    >
                        Recruit this cat
                    </Button>
                ) : (
            ...
            <Modal show={namingModal} onHide={namingModalClose}>
                <Modal.Body>
                    <Form onSubmit={handleFormSubmit}>
                        <Form.Group>
                            <Form.Label>Name your cat!</Form.Label>
                            <Form.Control
                                type="text"
                                name="catName"
